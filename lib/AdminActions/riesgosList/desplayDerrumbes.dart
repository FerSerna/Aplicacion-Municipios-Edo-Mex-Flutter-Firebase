...
class _DesplayDerrumbes extends State<DesplayDerrumbes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Con peligro de Derrumbes'),
        centerTitle: true,
      ),
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 10),
              Text(
                  'Superficie Suceptible a Derrumbe: \n' + superficieSuseptible,
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        String clave = claveIGECEM.replaceAll("clave", "id_derrumbes");
                        ...
                        Alert(
                            context: context,
                            title: "Ha sido borrada el derrumbe en $municipio",
                            buttons: []).show();
                      },
                      icon: Icon(
                        Icons.delete,
...
class EditDerrumbes extends StatefulWidget {
  ...
  @override
  _EditDerrumbesState createState() => _EditDerrumbesState(
      _eIclaveIGECEM,
      _eImunicipio,
      _eIporcentajeSuceptabilidad,
      _eIsuperficie,
...
class _EditDerrumbesState extends State<EditDerrumbes> {
  String _claveIGECEM,
      _municipio,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Editando información sobre Derrumbe'),
        centerTitle: true,
      ),
          ...
          child: Form(
            ...
            child: Column(
              children: <Widget>[
                ...
                RaisedButton(
                  child: Text('Actualizar información de derrumbe'),
                  color: Colors.orange,
                  onPressed: uploadDerrumbe,
                ),
